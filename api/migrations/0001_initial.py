# Generated by Django 5.2.8 on 2025-11-24 07:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('doctor', 'Врач')], default='doctor', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Создано'), ('processing', 'Обработка (Транскрибация)'), ('generating', 'Генерация отчета'), ('ready', 'Готово'), ('error', 'Ошибка')], default='created', max_length=20)),
